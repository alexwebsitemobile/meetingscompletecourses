				...
				$this->post_args['sfwd-lessons']['fields'] = array_merge(
					...
					array(
						...
						'lesson_video_url' => array( 
							...
							'type' => 'text', 
							'help_text' => sprintf( _x( 'URL to video. The video will be added above the %s content. Use the shortcode %s to position the player within content. Supported URL formats are YouTube (youtu.be, youtube.com), Vimeo (vimeo.com), or Local videos. The value for this field can be a simple URL to the video, an iframe or [video] shortcode.', 'placeholder: Lesson, admin URL to [ld_video] shortcode.', 'learndash' ), LearnDash_Custom_Label::get_label( 'lesson' ), '<a href="'. admin_url('admin.php?page=courses-shortcodes#shortcode_ld_video' ) .'">[ld_video]</a>' ),
							'default' => '',
						),
				...
				$this->post_args['sfwd-topic']['fields'] = array_merge(
					...
					array(
						...
						'lesson_video_url' => array( 
							'name' => __( 'Video URL', 'learndash' ), 
							'type' => 'text', 
							'help_text' => sprintf( _x( 'URL to video. The video will be added above the %s content. Use the shortcode %s to position the player within content. Supported URL formats are YouTube (youtu.be, youtube.com), Vimeo (vimeo.com), or Local videos. The value for this field can be a simple URL to the video, an iframe or [video] shortcode.', 'placeholder: Topic, admin URL to [ld_video] shortcode.', 'learndash' ), LearnDash_Custom_Label::get_label( 'topic' ), '<a href="'. admin_url('admin.php?page=courses-shortcodes#shortcode_ld_video' ) .'">[ld_video]</a>' ),
							'default' => '',
						),
						'lesson_video_auto_start' => array( 
							'name' => __( 'Auto Start Video', 'learndash' ), 
