...
function callback_theme_options() {
    if (isset($_POST['update'])) {
        ...
        $logo_src_dark = esc_attr($_POST['logo-src-dark']);
        $logo_alt_dark = esc_attr($_POST['logo-alt-dark']);
        ...
        update_option('theme_options_logo_src_dark', $logo_src_dark);
        update_option('theme_options_logo_alt_dark', $logo_alt_dark);
        ...
        $logo_alt_dark = get_option('theme_options_logo_alt_dark');
    ...
    <div class="wrap">
        ...
        <form action="" method="post">
            ...
            <table class="form-table">
                <tr valign="top">
                    <th scope="row">
                        <label for="logo-src-dark">Logo Dark:</label>
                    </th>
                    <td>
                        <input type="text" id="logo-src-dark" name="logo-src-dark" class="src" value="<?php echo $logo_src_dark; ?>" />
                        <input type="hidden" id="logo-alt-dark" name="logo-alt-dark" class="alt" value="<?php echo $logo_alt_dark; ?>" />
                        <input type="button" id="logo-btn" class="upload-button button" value="Add Image" />
                        <a href="#" class="upload-reset">Remove</a>
                    </td>
                </tr>
                <?php if (!empty($logo_src_dark)) : ?>
                    <tr valign="top">
                        <td>&nbsp;</td>
                        <td><img src="<?php echo $logo_src_dark; ?>" alt="<?php echo $logo_alt_dark; ?>" /></td>
                    </tr>
                <?php endif; ?>
            </table>
