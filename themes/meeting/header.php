...
<html <?php language_attributes(); ?> class="no-js">
    ...
    <body <?php body_class() ?> itemscope itemtype="http://schema.org/WebPage">
        ...
        ?>) 50% 0 no-repeat fixed #707070;background-size: cover;background-position: center bottom;">
                                ...
                                <div class="col-sm-2 hidden-xs">
                                    ...
                                    <div class="wrap-logo-r">
                                        ...
                                        if (!empty($logo_src_dark)) {
                                            ?>
                                            <a href="<?php echo home_url(); ?>">
                                                <img src="<?php echo $logo_src_dark; ?>" alt="<?php echo get_option('theme_options_logo_alt_dark'); ?>" class="img-responsives" style="max-width: 145px;">
                                            </a>
                                        <?php } ?>
                                    </div>
                                </div>
...
<div class="show-button-course" style="display: none;">
    <div class="container text-left">
	<a href="<?php echo home_url('courses/setting-up-a-meeting/'); ?>" class="prev-link" rel="next"><span class="meta-nav">←</span> Back to lesson menu </a>
    </div>
</div>